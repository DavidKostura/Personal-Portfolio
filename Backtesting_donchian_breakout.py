...
# ============================= KONFIGURACIA =====================================
# Tu mozes menit vsetky parametre podla potreby

TICKERS = ["AAPL", "MSFT", "COST", "NVDA", "META", "GOOGL", "AMZN", "TSLA"]  # Mozes pridat kolko chces
START_DATE = "2020-01-01"
END_DATE = "2024-01-01"
LOOKBACK_PERIODS = [10, 20, 30, 40, 50, 60]  # Konfiguracie lookback period
SHOW_PLOTS = True  # True = zobraz grafy, False = bez grafov
TOP_N = 5  # Kolko top konfiguracii zobrazit
...
def rolling_max_min(prices, window):
    ...
    # Vypocet rolling maximum a minimum pre dany window
...
def backtest(prices, returns, lookback):
    ...
    # Backtest tej donchian strategie
...
all_results = []
failed_tickers = []
best_equity_curves = {}  # Pre ulozenie equity kriviek top konfiguracii
...
# Hladanie najlepsich konfiguracii
console.print("\n" + "="*80)
...
# Tabulka najlepsej konfiguracie
...
# Tabulka top n podla sharpe ratio
console.print("\n")
...
# Tabulka pre porovnanie tickerov
console.print("\n")
...
if SHOW_PLOTS:
    # Nastavenie stylu - cierne pozadie a zelene grafy
    plt.style.use('dark_background')
    
    # Vytvorenie 2x2 gridu pre tabulky
    fig = plt.figure(figsize=(18, 11))
    fig.patch.set_facecolor('#0a0a0a')
    
    # Graf 1 - top konfiguracie, equity curve
    ...
    # Graf 2 - return vs sharpe scatter
    ...
    # Graf 4 - bar chart - Najlepsie konfiguracie podla tickera
    ...
    # Pridanie hodnot nad stlpce s odstupom
    for bar in bars:
